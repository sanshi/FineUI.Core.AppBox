...
namespace FineUI.Core.AppBox
{
    ...
    public static class AppBoxDatabaseInitializer
    {
        public static void Initialize(AppBoxContext context)
        {
            ...
            // 添加菜单时设置ViewPower对象，所以需要先保存到数据库
            context.SaveChanges();
        ...
        private static List<Config> GetConfigs()
        {
            var configs = new List<Config> {
                ...
                {
                    ConfigKey = "Title",
                    ConfigValue = "FineUI.Core.AppBox",
                    Remark = "网站的标题"
                },
                new Config
                {
